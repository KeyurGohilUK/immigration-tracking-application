...
export function renderHouseholdMemberDialogMarkup(): string {
  return renderLiquidGlassDialog({
    ...
    formId: "family-form",
    eyebrow: "Encrypted local profile",
      ...
      <div class="member-profile-fields">
        <div class="member-profile-field">
          ...
          <div class="member-profile-control">
            <span class="member-profile-control-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><rect x="4" y="6" width="16" height="12" rx="2"/><circle cx="9" cy="11" r="2"/><path d="M13 10h4M13 14h4"/></svg></span>
        ...
        <div class="member-profile-field">
          ...
          <div class="member-profile-control">
            <span class="member-profile-control-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><rect x="4" y="6" width="16" height="14" rx="2"/><path d="M8 3v5M16 3v5M4 10h16"/></svg></span>
        ...
        <div class="member-profile-field">
          ...
          <div class="member-profile-control member-profile-select-control">
            <span class="member-profile-control-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M6 3h9l3 3v15H6Z"/><path d="M15 3v4h4M9 11h6M9 15h6"/></svg></span>
    ...
    actions: `<button id="delete-household-member" class="secondary-button danger-button" type="button" hidden>Delete member</button>
    ...
    dialogClass: "member-profile-dialog",
    formClass: "member-profile-form",
    headerClass: "member-profile-header",
    closeLabel: "Close family form",
  });
}
