    ...
    `<main id="main-content" class="more-main profile-main">
      ...
      <div class="more-grid">
        ...
        <details class="more-card settings-group app-settings-card collapsible-settings-section">
          ...
          <div class="settings-section-content">
            <div class="settings-list">
            <div class="settings-row theme-settings-row"><span class="settings-row-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M12 3a9 9 0 1 0 9 9 7 7 0 0 1-9-9Z"/></svg></span><div><h3>Theme</h3><p>Follow your device or choose a fixed appearance.</p></div><fieldset class="theme-segmented-control" aria-label="Theme preference"><legend class="visually-hidden">Theme preference</legend><label><input type="radio" name="theme-preference" value="dark" /><span>Dark</span></label><label><input type="radio" name="theme-preference" value="system" /><span>System</span></label><label><input type="radio" name="theme-preference" value="light" /><span>Light</span></label></fieldset></div>
