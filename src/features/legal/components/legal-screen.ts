      ...
      <main class="legal-main">
        ...
        <article class="legal-content">
          ...
          <section id="privacy"><h2>Privacy and local data</h2>
            ...
            <p>No analytics or advertising trackers are included. Profile records and uploaded document files are encrypted and stored locally in this browser. New encrypted JSON backups include document files; legacy backups may not. You are responsible for retaining originals and storing downloaded backups securely.</p>
            <p>The optional UK postcode lookup sends only the postcode you enter to Ideal Postcodes when you choose Find address so that matching postal addresses can be returned. Selecting or manually entering an address does not create an UrbanFox online account or application database; saved address-history records remain encrypted locally in this browser.</p>
          </section>
