...
export function renderTripsPage(
  ...
  renderAppShell(
    ...
    <dialog id="trip-dialog" class="family-dialog" aria-labelledby="trip-form-title">
      <form id="trip-form" class="family-form" novalidate>
        <div class="app-manager-heading">
          <div><p class="eyebrow">Encrypted local record</p><h2 id="trip-form-title">Add trip</h2></div>
          <button class="dialog-close" type="button" aria-label="Close trip form">×</button>
        </div>
        ...
        <label class="checkbox-field" for="exceptional-absence">
