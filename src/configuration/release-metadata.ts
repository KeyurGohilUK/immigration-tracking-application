...
export const RELEASE_NOTES = [
  "Production PWA CI now serves the built app from the GitHub Pages repository subdirectory and verifies relative assets, manifest paths, release checks, service-worker scope, and offline reload.",
