...
export const RELEASE_NOTES = [
  ...
  "The install action is now hidden when UrbanFox is already installed on the device.",
  "The duplicate Install and updates row has been removed from Profile and settings.",
