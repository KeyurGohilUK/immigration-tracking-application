# UrbanFox ILR — Archived Product Roadmap

Archived on 4 September 2026 after reconciling the original roadmap with the implemented application. Completed items are retained here for historical context. Tasks were originally ordered
...
- [x] Document local development, testing, and GitHub Pages deployment.
...
- [x] Ensure forms work comfortably on narrow mobile screens and with keyboards.
- [x] Add useful validation messages without presenting legal conclusions.
...
- [x] Apply an original, consistent translucent glass style across headers,
...
- [x] Respect reduced-motion preferences and avoid distracting animation during
...
- [x] Show a rolling-absence risk summary without implying legal certainty.
...
- [x] Use large touch targets and mobile safe-area padding.
...
- [x] Test exactly 180 days and more than 180 days.
- [x] Test overlapping rolling windows containing multiple trips.
- [ ] Test leap years, month ends, year ends, and daylight-saving transitions.
- [x] Test the 28-day application window.
...
- [x] Test that encrypted records are not readable directly from IndexedDB.
...
- [x] Add browser tests for the principal mobile user journey.
